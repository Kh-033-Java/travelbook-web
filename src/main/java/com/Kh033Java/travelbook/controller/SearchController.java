...
public class SearchController {
    ...
    public List<PlanDTO> findPlanWithFilters(@RequestBody PlanSearchDTO planSearchDTO) {//(@RequestParam int budget_min, @RequestParam int budget_max, @RequestParam String date_min, @RequestParam String date_max, @RequestParam int amount_of_people_min, @RequestParam int amount_of_people_max, @RequestParam String transport, @RequestParam String start_city, @RequestParam String end_city) {
        System.out.println(planSearchDTO);
